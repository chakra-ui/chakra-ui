...
function styledFn(Dynamic, configOrCva = {}, options = {}) {
  ...
  const ChakraComponent = /* @__PURE__ */ forwardRef(function ChakraComponent(props, ref) {
  ...
  ChakraComponent.displayName = `chakra.${name}`
  ChakraComponent.__cva__ = __cvaFn__
  ChakraComponent.__base__ = __base__
  ChakraComponent.__shouldForwardProps__ = shouldForwardProp
...
export const chakra = /* @__PURE__ */ createJsxFactory()
