...
We recently launched Chakra UI **v3**. If you've been working with version 2,
you're probably wondering, "What’s in v3, and how is it different from v2?"

In this blog post, I’ll give you a rundown of the major changes and updates that
make up **v3**.
