...
description:
  "Day 2 of Chakra Launch Week is all about improving your Chakra UI developer
  experience."
type: announcement
authors: ["sage", "esther"]
...
## Smarter Docs with Markdown Copy
...
### Introducing the Brand New `CodeBlock` Component

We are officially launching a brand new [CodeBlock](/docs/component/code-block)
component.

Our new CodeBlock component is a fully-featured solution for displaying code
with:
...
Our goal today was simple: to make it easier than ever to build with Chakra UI.
We believe these three updates: smarter docs, one-click StackBlitz, and the new
