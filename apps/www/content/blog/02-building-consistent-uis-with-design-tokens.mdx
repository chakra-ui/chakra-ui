...
description: Design tokens allow developers to create maintanable UIs.
type: article
authors: ["esther"]
publishedAt: "2024-11-12"
---

Design tokens allow developers to create user interfaces that are cohesive,
...
play a key role in allowing you create scalable, cohesive, and consistent user
interfaces.
...
## Utilize Core Design Tokens for Scalability
...
- Colors: Chakra UI provides a wide palette of color tokens, ranging from `.50`
  to `.950` such as `gray.50`, `gray.300`, etc.
...
- Typography: Chakra provides font size and weight tokens, so your app’s text
  elements maintain a uniform appearance. By specifying tokens like lg, md, or
  xl for font sizes, you reduce the likelihood of inconsistent text styling.
...
#### Customizing Core Design Tokens
...
### Use Semantic Tokens for Contextual Designs
...
#### Customizing with Theme Extensions
...
## Build Scalable Applications with Design Tokens
