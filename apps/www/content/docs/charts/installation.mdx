...
In most cases, you will only need to import the `Charts` and `useChart` hooks
from the `@chakra-ui/charts` package, then combine them with the components
`recharts`
...
component within the `Charts.Root` component.
