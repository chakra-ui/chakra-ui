...
You can modify the appearance of the grid lines using `stroke`,
`strokeDasharray`, and `opacity`
...
If you want to remove the grid completely, simply omit the `CartesianGrid`
component or explicitly hide both horizontal and vertical lines:
