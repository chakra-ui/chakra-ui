...
<ExampleTabs name="date-input-with-variants" />
...
<ExampleTabs name="date-input-default-value" />

### Min and Max

Use the `min` and `max` props to restrict the range of accepted dates.

<ExampleTabs name="date-input-min-max" />
...
<ExampleTabs name="date-input-time-zone" />
...
<ExampleTabs name="date-input-locale" />
