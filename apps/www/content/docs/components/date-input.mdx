...
`DateInput.Segments` renders a segment group with every segment for the current
`granularity` and `formatter`. Replace it with `DateInput.SegmentGroup` to
...
<PropTable component="DateInput" part="RootProvider" />

### Segments

<PropTable component="DateInput" part="Segments" />

### Segment

<PropTable component="DateInput" part="Segment" />

### HiddenInput

<PropTable component="DateInput" part="HiddenInput" />
