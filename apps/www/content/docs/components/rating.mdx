...
If you don't need to customize the rating icons or indicators, you can render
the `RatingControl` as a self closing element. By default, the control will
render the number of items specified in the `count` prop.
