...
links:
  ...
  recipe: button
---
>Tip: Always use descriptive text inside buttons (avoid generic labels like "Click me") to improve accessibility and user experience.
...
<Button colorScheme="green">My First PR 🚀</Button>
