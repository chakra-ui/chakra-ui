...
Support slides of different widths for more dynamic layouts.

<ExampleTabs name="carousel-with-variable-width" />

### Multiple Slides Per View

Display several slides simultaneously with the `slidesPerPage` prop. Use
`slidesPerMove` to control how many slides advance with each interaction.
...
Use carousel in a `Dialog` to create a first-run experience or modal gallery.
