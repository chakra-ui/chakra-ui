...
<ResourceCard
  type="github"
  title="Next.js app (streaming)"
  url="https://github.com/chakra-ui/chakra-ui/tree/main/sandbox/next-app-streaming"
/>
...
### Stream through Suspense (optional)
...
```tsx title="components/ui/emotion-registry.tsx"
"use client"
...
```tsx title="app/layout.tsx" {1,8,10}
...
The
[streaming sandbox](https://github.com/chakra-ui/chakra-ui/tree/main/sandbox/next-app-streaming)
is a repro you can run cold, not a copy of the layout above.
...
Turbopack is hydrating Emotion CSS incorrectly. Add `--webpack` to your `dev`
and `build` scripts:
