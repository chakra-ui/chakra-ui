...
chakra eject --outdir ./theme

# Copy the tokens to your project
chakra eject tokens --outdir ./theme

# Copy the recipes to your project
chakra eject recipes --outdir ./theme
```
