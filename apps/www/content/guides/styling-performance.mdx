...
description:
  Optimize styling performance by avoiding dynamic conditional styles and using
  data attributes, style attributes, and recipes
...
Use whichever is more readable for your component. For simple static styles,
style props are usually the clearest choice.
...
dynamic conditional style props. The styles are pre-compiled and don't change at
runtime.
