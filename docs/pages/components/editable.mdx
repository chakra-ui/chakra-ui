...
title: "Editable Text"
description:
  "EditableText is used for inline renaming of some text. It appears as normal
  UI text but transforms into a text input field when the user clicks or focuses
  on it."
---
...
`Editable` component composes the [Box](/box) component so can pass all `Box`
