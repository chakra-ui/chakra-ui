...
Chakra providers are needed to give your whole website context of the theme, and
colormode defined by Chakra.
...
If you're still working on v 0.8.0, the providers will be a bit different as
seen below.
