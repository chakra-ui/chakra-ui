...
| id            | `string`             |         | Unique id to be used by menu and it's children                               |
| closeOnSelect | `boolean`            | `true`  | If `true`, the menu will close when a menu item is clicked                   |
| closeOnBlur   | `boolean`            | `true`  | If `true`, the menu will close when you click outside the menu list          |
| autoSelect    | `boolean`            | `true`  | If `true`, the first enabled menu item will be selected when the menu opens. |
| isLazy        | `boolean`            |         | If `true`, the MenuItem rendering will be deferred until the menu is open.   |
| isOpen        | `boolean`            |         | If `true`, the top-level menu will be opened in controlled mode              |
| defaultIsOpen | `boolean`            |         | If `true`, the top-level menu will be opened in un-controlled mode           |
| onOpen        | `boolean`            |         | Function to be called when menu is open                                      |
| onClose       | `boolean`            |         | Function to be called when menu is closed                                    |
| placement     | `PopperJS.placement` |         | The placement of the `MenuList`                                              |
| fixed         | `PopperJS.fixed`     |         | The strategy for positioning the `MenuList`                                  |

### MenuButton Props

| Name      | Type                         | Description                                             |
| --------- | ---------------------------- | ------------------------------------------------------- |
| onClick   | `React.MouseEventHandler`    | Function to be called when you click on the menu button |
| onKeyDown | `React.KeyboardEventHandler` | Function that is called on keydown                      |
...
| iconSpacing | `CSS.Padding`             | The spacing between the icon and menu item's label.              |
