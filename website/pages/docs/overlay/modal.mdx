...
| motionPreset        | `scale, slideInBottom, slideInRight` | `scale`   | The default animation or transition to apply to the modal                                                                           |
| initialFocusRef     | `React.Ref`                          |           | The least destructive action to get focus when dialog is open                                                                       |
| finalFocusRef       | `React.Ref`                          |           | The least destructive action to get focus when dialog is closed                                                                     |
