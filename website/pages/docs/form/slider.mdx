...
opt-out of this behavior by setting the value of `focusThumbOnChange` to `false`. This is normally
...
| `aria-labelledby`  | `string`                   |         | The `id` of the element that labels the `Slider.                           |
