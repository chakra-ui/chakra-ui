...
Setting the progress to indeterminate means you're not able to determine the `value` upfront, so you won't need to pass the `value` prop.

```jsx
<CircularProgress color="green.300"></CircularProgress>
```
