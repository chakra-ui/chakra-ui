...
You can add `colorScheme` prop to any progress bar to apply any color that exists
in the `theme`.

```jsx
<Progress size="xs" colorScheme="pink" />
```
...
- `Progres`s has `aria-valuenow` set to the percentage completion value passed to
