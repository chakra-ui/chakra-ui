...
While there's quite a number of new exciting Features 🚀 we've added, we focused
on making Chakra UI a stable base to build your own design systems on, so that
you can feel more confident using Chakra UI in production.
