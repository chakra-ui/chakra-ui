...
> create your custom component styles. [Learn more](/docs/theming/create).
...
```jsx live=false
// theme.js
import { extendTheme, mode } from "@chakra-ui/theme"
...
> WARNING: If you do use a function in a style override, you will NOT inherit
> the existing styles like you will with an object. `extendTheme` will only
> merge style objects, not functions
...
create custom component styles and use them in your components!
