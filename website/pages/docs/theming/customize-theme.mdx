...
> If you're curious as to what theme styles you can override, please reference the
...
> If you're curious as to what component styles you can override, please reference the
...
Global styles are theme-aware styles you can apply to any html element
globally.
