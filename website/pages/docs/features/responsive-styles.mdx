...
const breakpoints = ["0em", "30em", "48em", "62em", "80em", "90rem"]
```
...
<>
  ...
  <Box fontSize={["sm", "md", "lg", "xl", "xxl"]}>Font Size</Box>
  {/* responsive margin */}
  <Box mt={[2, 4, 6, 8, 10]} width="full" height="24px" bg="tomato" />
  {/* responsive padding */}
  <Box bg="papayawhip" p={[2, 4, 6, 8, 10]}>
    Padding
  </Box>
</>
```
