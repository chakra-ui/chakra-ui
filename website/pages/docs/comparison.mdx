...
Material UI is like any other CSS framework like bootstrap to help you get started quick on your projects. Their components follow a certain design principle (which makes it not very unique) and also does not allow heavy customization on custom components. Chakra does not follow any design principle and can be customized freely with the any choice of yours. Moreover, if you've used tailwind, I'm pretty sure you'll love chakra!
