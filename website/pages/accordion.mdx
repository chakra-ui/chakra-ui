...
<SEO
  title="Accordion"
  description="Accordions display a list of high-level options that can expand/collapse to
...
AccordionButton renders a `button` and composes `PseudoBox`, this means you can
