...
```tsx live=false
import { forwardRef, Box, BoxProps } from "@chakra-ui/core"

const MyBox = forwardRef<BoxProps, "div">((props, ref) => (
  <Box ref={ref} {...props} />
))
```
...
```tsx live=false
import { ChakraComponent, Box, BoxProps } from "@chakra-ui/core"

type DivComponent = ChakraComponent<"div", {}>

const MyBox = ((props: BoxProps) => <Box {...props} />) as DivComponent
```
...
const MyBox = chakra("div", {
  baseStyle: {}, // attach style props
})
```
