...
All the steps above work for Google Fonts, except in your `font-imports.js`
file, you can greatly simplify and put the appropriate `@import` command from
the **Embed** tab:
...
Make sure to match the `font-family` declaration in your `theme.js` file to what
Google fonts specifies, for example, `font-family: 'Balsamiq Sans', cursive;`
for the above import.
