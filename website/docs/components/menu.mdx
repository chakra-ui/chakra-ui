...
| trigger       | `click`, `hover`     | `click`   | The interaction that triggers the menu                                              |
| openDelay     | `number`             | `200`     | If trigger is "hover", opening the menu is delayed by specified amount of time (ms) |
| closeDelay    | `number`             | `200`     | If trigger is "hover", closing the menu is delayed by specified amount of time (ms) |
### MenuButton Props
