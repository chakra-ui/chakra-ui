...
<Wrap shouldWrapChildren spacing={6}>
  ...
  <Tooltip label="Opened after 500ms" showDelay={500}>
    <Button>Delay Open - 500ms</Button>
  </Tooltip>

  <Tooltip label="Closed after 500ms" hideDelay={500}>
...
| `showDelay`          | `number`             | `200`    | The delay in `ms` for the tooltip to show                                             |
| `hideDelay`          | `number`             | `200`    | The delay in `ms` for the tooltip to hide                                             |
