...
We recommend trying to solve stacking issues without `z-index`. You can read
our recommendations and learn more about 
[stacking contexts and z-index here](/z-index).

Chakra provides a minimal set of z-indeces out of the box to help
control the stacking order of components.
