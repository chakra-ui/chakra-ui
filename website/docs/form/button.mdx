...
- **ButtonGroup:** Used to group buttons together with an option to flush them
  together.
...
| `colorScheme` | `string`                                          | `blue`  | The color scheme of the button. Use the colors in `theme.colors` that have `50` - `900` values            |
