...
- It introduces scaling issues, which you can manage with global values
(such as a [theme](theming/theme#z-index-values)).
...
be certain that any children you render with Portal will always appear on top
of everything else in your application, regardless of child stacking contexts.
...
If you're interested in learning more about `z-index` and stacking contexts, check
