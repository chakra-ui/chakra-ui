...
function ResizeExample() {
  ...
  return (
    <>
      <RadioGroup.Root defaultValue={resize} onChange={setResize} mb={6}>
        <Stack direction='row' spacing={5}>
          <RadioGroup.Item value='horizontal'>Horizontal</RadioGroup.Item>
          <RadioGroup.Item value='vertical'>Vertical</RadioGroup.Item>
