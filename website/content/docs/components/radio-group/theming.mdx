...
The `RadioGroup` component is a multipart component. The styling needs to be
...
The properties that affect the theming of the `RadioGroup.Item` component are:
...
<RadioGroup.Item size="xl">This is a radio</RadioGroup.Item>
```
...
<RadioGroup.Item variant="outline" ... />
```
...
<RadioGroup.Item size="xl" variant="outline">This is a radio</RadioGroup.Item>
```
