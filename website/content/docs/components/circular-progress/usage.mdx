...
Chakra exports a `CircularProgress.ValueText` to help you add a value text. Pass
this component as `children` prop and you'll be able to render the value.
...
<CircularProgress.Root value={40} color='green.400'>
  ...
  <CircularProgress.ValueText>40%</CircularProgress.ValueText>
</CircularProgress.Root>
```
