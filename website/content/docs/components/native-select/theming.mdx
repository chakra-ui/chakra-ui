...
The `NativeSelect` component is a multipart component. The styling needs to be
...
The properties that affect the theming of the `NativeSelect` component are:
...
<NativeSelect.Root variant="brandPrimary" ... />
```
...
<NativeSelect.Root size="xl" variant="pill" ... />
```
