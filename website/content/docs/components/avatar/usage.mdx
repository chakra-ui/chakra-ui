...
- `Avatar.Badge`: A wrapper that displays its content on the right corner of the
  avatar.
...
> Note the use of `em` for the size of the `Avatar.Badge`. This is useful to
> size the badge relative to the avatar font size.
