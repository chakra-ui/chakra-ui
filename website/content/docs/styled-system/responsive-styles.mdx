...
Responsive syntax relies on the breakpoints defined in the
[theme object](https://v2.chakra-ui.com/docs/styled-system/theme). Chakra UI
provides
[default breakpoints](https://github.com/chakra-ui/chakra-ui/blob/f5b1a3569fd0c654897d2397b3d0bd4677783fa7/packages/utilities/breakpoint-utils/src/responsive.ts#L3C17-L3C17).

Default breakpoints are defined using
[`em`](https://www.w3.org/Style/Examples/007/units.en.html#units) unit:
...
> The breakpoints are: `base = 0em`, `sm = 30em`, `md = 48em`, `lg = 62em`,
> `xl = 80em,`, `2xl = 96em`
...
> Note: Make sure you are using the same CSS unit for all of your breakpoints.
> Use all `px` or all `em`, don't mix them!
