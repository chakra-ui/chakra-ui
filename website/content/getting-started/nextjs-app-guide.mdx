...
<PackageManagers
  command={{
    npm: 'npm i @chakra-ui/react@2 @chakra-ui/next-js @emotion/react @emotion/styled framer-motion',
    yarn: 'yarn add @chakra-ui/react@2 @chakra-ui/next-js @emotion/react @emotion/styled framer-motion',
    pnpm: 'pnpm add @chakra-ui/react@2 @chakra-ui/next-js @emotion/react @emotion/styled framer-motion',
  }}
/>
...
Alternatively, if a hydration error is thrown in Next.js 13 after integrating
`Providers` in the `Layout`, replace the `Providers` code with the following
implementation:
