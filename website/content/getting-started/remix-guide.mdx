...
<PackageManagers
  command={{
    npm: 'npm i @chakra-ui/react@2 @emotion/react@^11 @emotion/styled@^11 framer-motion@^6 @emotion/server@^11',
    yarn: 'yarn add @chakra-ui/react@2 @emotion/react@^11 @emotion/styled@^11 framer-motion@^6 @emotion/server@^11',
    pnpm: 'pnpm add @chakra-ui/react@2 @emotion/react@^11 @emotion/styled@^11 framer-motion@^6 @emotion/server@^11',
    bun: 'bun add @chakra-ui/react@2 @emotion/react@^11 @emotion/styled@^11 framer-motion@^6 @emotion/server@^11',
  }}
/>
