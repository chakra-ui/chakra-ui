---
title: Version 1.7.0
description: Explore the changelog for Chakra UI version 1.7.0. Learn about the latest features, bug fixes, and improvements.
...
-   [#4995](https://github.com/chakra-ui/chakra-ui/pull/4995)
    ...
    in JSDOM: [https://github.com/theKashey/focus-lock/pull/24](https://github.com/theKashey/focus-lock/pull/24)
