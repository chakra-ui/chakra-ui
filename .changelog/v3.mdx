...
- **Charts**: Initial release of the `@sh3yk0-ui/charts` package.
...
```bash
npx @sh3yk0-ui/cli snippet add [...components] --tsx
```

- **[New] Panda**: Initial release of `@sh3yk0-ui/panda-preset`. This allows you
