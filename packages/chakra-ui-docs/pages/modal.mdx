...
> 🚨 Version (v0.3.2) introduced a breaking change to this component's API.
...
unpleasant content shift.

To prevent this, pass the `preserveScrollBarGap` prop. It applies a
...
| preserveFocusLock    | `boolean`                                     | `true`    | If `true`, the focus retention will be enabled on the modal.                                                                            |
