...
| `defaultIsOpen`      | `boolean`                                                      | `false`  | If `true`, the popover is shown initially.                                                                                                                                                                                 |
...
| `returnFocusOnClose` | `boolean`                                                      | `bottom` | If `true`, the popover will return focus to the trigger when it closes                                                                                                                                                     |
