...
- `Menu`: The wrapper component that uses provides context, state, and focus
  management.
...
| type         | `radio`, `checkbox`       | The initial value of the option group                   |
| onMouseLeave | `React.MouseEventHandler` | The value of the option group.                          |
