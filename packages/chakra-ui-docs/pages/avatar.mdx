...
<List isInline>
  ...
  <Avatar size="xs" name="Uchiha Itachi" src="http://bit.ly/uchiha-itachi" />
...
```jsx
<Avatar badge={<AvatarBadge size="1.25em" bg="green.500" />} />
```
...
| `badge`      | `React.ReactNode`                          |         | The badge at the bottom right corner of the Avatar.                               |
