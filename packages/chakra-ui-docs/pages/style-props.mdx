...
// default space for margin and padding from styled-system
// const space = [0, 4, 8, 16, 32, 64, 128, 256, 512]

// m={2} refers to the value of `theme.space[2]`(`8px`)
<Box m={2}>Tomato</Box>;

// You can also use custom values
<Box maxW="960px" mx="auto" />;

// sets margin `theme.space[2]`(`8px`) on all viewports and `theme.space[3]`(`16px`) from the first breakpoint and up
<Box m={[2, 3]} />;
```
...
| `roundedTop`                                    | `border-top-left-radius` and `border-top-right-radius`       | `radii`     |
| `roundedRight`                                  | `border-top-right-radius` and `border-bottom-right-radius`   | `radii`     |
| `roundedBottom`                                 | `border-bottom-left-radius` and `border-bottom-right-radius` | `radii`     |
| `roundedLeft`                                   | `border-top-left-radius` and `border-bottom-left-radius`     | `radii`     |
