...
`Breadcrumb` composes [Box](/box) so you can pass all `Box` props to change the style
...
The BreadcrumbLink composes the [Link](/link) component so you can all Link props.
