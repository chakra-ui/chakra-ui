...
```jsx
<Stack spacing={10} isInline>
  <Checkbox color="red" defaultIsChecked>
    Checkbox
  </Checkbox>
  <Checkbox color="green" defaultIsChecked>
    Checkbox
  </Checkbox>
</Stack>
```
...
<Stack spacing={10} isInline>
  ...
  <Checkbox size="md" color="green" defaultIsChecked>
    Checkbox
  </Checkbox>
  <Checkbox size="lg" color="orange" defaultIsChecked>
    Checkbox
  </Checkbox>
</Stack>
```
...
```jsx
<CheckboxGroup color="green" defaultValue={["naruto", "kakashi"]}>
