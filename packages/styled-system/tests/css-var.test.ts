  ...
  expect(
    ...
    Object {
      ...
      "__cssVars": Object {
        ...
        "--ck-transform": "translateX(var(--translate-x, 0)) translateY(var(--translate-y, 0)) rotate(var(--rotate, 0)) scaleX(var(--scale-x, 1)) scaleY(var(--scale-y, 1)) skewX(var(--skew-x, 0)) skewY(var(--skew-y, 0))",
        "--ck-transform-gpu": "translate3d(var(--translate-x, 0), var(--translate-y, 0), 0) rotate(var(--rotate, 0)) scaleX(var(--scale-x, 1)) scaleY(var(--scale-y, 1)) skewX(var(--skew-x, 0)) skewY(var(--skew-y, 0))",
        "--ring": "var(--ck-ring-offset-shadow), var(--ck-ring-shadow), 0 0 transparent",
        "--space-lg": "24px",
        "--space-md": "16px",
        "--space-sm": "8px",
      },
