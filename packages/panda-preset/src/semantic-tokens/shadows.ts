...
export const shadows = defineSemanticTokens.shadows({
  xs: {
    value: {
      ...
      _dark:
        "0px 1px 1px {colors.black/64}, 0px 0px 1px inset {colors.gray.300/20}",
    },
  },
  sm: {
    value: {
      ...
      _dark:
        "0px 2px 4px {colors.black/64}, 0px 0px 1px inset {colors.gray.300/30}",
    },
  },
  md: {
    value: {
      ...
      _dark:
        "0px 4px 8px {colors.black/64}, 0px 0px 1px inset {colors.gray.300/30}",
    },
  },
  lg: {
    value: {
      ...
      _dark:
        "0px 8px 16px {colors.black/64}, 0px 0px 1px inset {colors.gray.300/30}",
    },
  },
  xl: {
    value: {
      ...
      _dark:
        "0px 16px 24px {colors.black/64}, 0px 0px 1px inset {colors.gray.300/30}",
    },
  },
  "2xl": {
    value: {
      ...
      _dark:
        "0px 24px 40px {colors.black/64}, 0px 0px 1px inset {colors.gray.300/30}",
    },
  },
  inner: {
    value: {
