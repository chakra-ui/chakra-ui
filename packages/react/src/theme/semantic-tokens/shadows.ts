...
export const semanticShadows = defineSemanticTokens.shadows({
  xs: {
    value: {
      base: "0px 1px 2px {colors.blackAlpha.500}, 0px 0px 1px {colors.blackAlpha.700}",
      _dark:
        "0px 1px 1px {colors.blackAlpha.800}, 0px 0px 1px inset {colors.blackAlpha.700}",
    },
  },
  sm: {
    value: {
      base: "0px 2px 4px {colors.blackAlpha.300}, 0px 0px 1px {colors.blackAlpha.700}",
      _dark:
  ...
  md: {
    value: {
      base: "0px 4px 8px {colors.blackAlpha.300}, 0px 0px 1px {colors.blackAlpha.700}",
      _dark:
  ...
  lg: {
    value: {
      base: "0px 8px 16px {colors.blackAlpha.300}, 0px 0px 1px {colors.blackAlpha.700}",
      _dark:
  ...
  xl: {
    value: {
      base: "0px 16px 24px {colors.blackAlpha.300}, 0px 0px 1px {colors.blackAlpha.700}",
      _dark:
  ...
  "2xl": {
    value: {
      base: "0px 24px 40px {colors.blackAlpha.300}, 0px 0px 1px {colors.blackAlpha.700}",
      _dark:
