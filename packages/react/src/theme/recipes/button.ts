  ...
  variants: {
    ...
    variant: {
      link: {
        ...
        _hover: {
          textDecoration: { base: "underline", _disabled: "none" },
        },
        _active: {
      ...
      ghost: {
        ...
        bg: "transparent",
        _hover: {
          bg: { base: "colorPalette.50", _dark: "colorPalette.300/12" },
        },
        _active: {
          bg: { base: "colorPalette.100", _dark: "colorPalette.400/24" },
        },
      },
      outline: {
        borderWidth: "1px",
        borderColor: { base: "colorPalette.200", _dark: "whiteAlpha.300" },
        "&[data-flush=horizontal]": {
          marginEnd: "-1px",
        },
        "&[data-flush=vertical]": {
          marginBottom: "-1px",
