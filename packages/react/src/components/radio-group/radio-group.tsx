...
export interface RadioGroupRootProviderBaseProps
  extends
    Assign<ArkRadioGroup.RootProviderBaseProps, SlotRecipeProps<"radioGroup">>,
    UnstyledProp {}

export interface RadioGroupRootProviderProps extends HTMLChakraProps<
  "div",
...
export interface RadioGroupRootBaseProps
  extends
    Assign<ArkRadioGroup.RootBaseProps, SlotRecipeProps<"radioGroup">>,
    UnstyledProp {}

export interface RadioGroupRootProps extends HTMLChakraProps<
  "div",
...
export interface RadioGroupItemControlProps
  extends
    HTMLChakraProps<"div", ArkRadioGroup.ItemControlBaseProps>,
    UnstyledProp {}
